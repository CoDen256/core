...
//    val parent =
//        path.parent() ?: throw IllegalArgumentException("$path must have at least one page parent to be created")
...
//}
//
//private fun NotionClient.getDatabase(path: NotionPath): SearchResult? = search(
//    query = path.title(),
//    filter = SearchRequest.SearchFilter("database", property = "object")
//)
//    .results
